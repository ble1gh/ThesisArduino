...
x_coeffs_Q1_tab = readtable("x_avg_coeffs_Q1.csv");
x_coeffs_Q1 = table2array(x_coeffs_Q1_tab);
x_coeffs_Q2_tab = readtable("x_avg_coeffs_Q2.csv");
x_coeffs_Q2 = table2array(x_coeffs_Q2_tab);
x_coeffs_Q3_tab = readtable("x_avg_coeffs_Q3.csv");
x_coeffs_Q3 = table2array(x_coeffs_Q3_tab);
x_coeffs_Q4_tab = readtable("x_avg_coeffs_Q4.csv");
x_coeffs_Q4 = table2array(x_coeffs_Q4_tab);

z_coeffs_Q1_tab = readtable("z_avg_coeffs_Q1.csv");
z_coeffs_Q1 = table2array(z_coeffs_Q1_tab);
z_coeffs_Q2_tab = readtable("z_avg_coeffs_Q2.csv");
z_coeffs_Q2 = table2array(z_coeffs_Q2_tab);
z_coeffs_Q3_tab = readtable("z_avg_coeffs_Q3.csv");
z_coeffs_Q3 = table2array(z_coeffs_Q3_tab);
z_coeffs_Q4_tab = readtable("z_avg_coeffs_Q4.csv");
