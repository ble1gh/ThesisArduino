...
reg_tab = readtable('20230512_reg_001.csv','Delimiter',',');
...
straight_tab = readtable('20230512_reg_002.csv','Delimiter',',');
...
writematrix(spinedata_in_modelspace,'transformed_output_0512.csv')
