...
reg_tab = readtable('20230514_reg_001.csv','Delimiter',',');
...
[~,TF_aurora_to_model,rmse] = rigid_align_svd(regpt_aurora(:,2:2:8),regpt_spine)
...
straight_tab = readtable('20230514_reg_002.csv','Delimiter',',');
qcoil = table2array(straight_tab(1,4:7));
tcoil = table2array(straight_tab(1,8:10));
...
rawcoil_tab = readtable('output_midplane.csv','Delimiter',',');
...
writematrix(spinedata_in_modelspace,'transformed_output_0514_midplane.csv')
