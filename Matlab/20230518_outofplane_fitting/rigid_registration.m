...
reg_tab = readtable('20230519_reg_002.csv','Delimiter',',');
...
[~,TF_aurora_to_model,rmse] = rigid_align_svd(regpt_aurora(:,3:4:16),regpt_spine)
...
straight_tab = readtable('20230519_reg_002.csv','Delimiter',',');
