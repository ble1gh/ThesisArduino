...
void loop() {
  ...
  while (1)
  {
  uint16_t mid = SERVOMID;
  uint16_t pos1 = mid;
  uint16_t pos2 = mid;    
    
  pwm.setPWM(servo1, 0, mid);
  pwm.setPWM(servo2, 0, mid);
  pwm.setPWM(servo3, 0, mid);
  pwm.setPWM(servo4, 0, mid);
